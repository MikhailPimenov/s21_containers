...
TEST(MultiMap, T0InsertMany) {
  ...
  s21_multimap.Insert_many(std::make_pair(666, Item(666)),
                           std::make_pair(777, Item(777)));

  EXPECT_EQ(s21_multimap, s21_multimap_expected);
}

TEST(MultiMap, T1InsertManyEmpty) {
  s21::MultiMap<int, Item> s21_multimap;
  ...
  s21::Vector<std::pair<s21::MultiMap<int, Item>::iterator, bool>> s21_result =
      s21_multimap.Insert_many(
...
TEST(MultiMap, T2InsertMany) {
  ...
  s21::Vector<std::pair<s21::MultiMap<int, Item>::iterator, bool>>
      s21_result_expected;
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(11, Item(11))));
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(22, Item(22))));
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(33, Item(33))));
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(44, Item(44))));
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(55, Item(55))));
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(66, Item(66))));
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(666, Item(666))));
  s21_result_expected.Push_back(
      s21_multimap2.Insert(std::make_pair(777, Item(777))));
...
TEST(MultiMap, T3InsertMany) {
  ...
  s21::MultiMap<int, Item> s21_multimap_expected{
      {11, Item(11)},   {22, Item(22)},   {33, Item(33)}, {44, Item(44, 'a')},
      {44, Item(44)},   {55, Item(55)},   {55, Item(55)}, {66, Item(66)},
      {666, Item(666)}, {777, Item(777)},
  };
