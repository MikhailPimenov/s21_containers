...
TEST(Set, T1InsertManyEmpty) {
  ...
  s21::Vector<std::pair<s21::Set<Item, ComparatorItem>::iterator, bool>>
      s21_result =
          s21_set.Insert_many(Item(11), Item(22), Item(33), Item(44), Item(55),
...
TEST(Set, T3InsertMany) {
  ...
  s21::Set<Item, ComparatorItem> s21_set_expected{
      Item(11), Item(22), Item(33),  Item(44, 'a'),
      Item(55), Item(66), Item(666), Item(777),
  };
