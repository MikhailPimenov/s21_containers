...
TEST(List, T1InsertManyEmptyBack) {
  ...
  s21_list.Insert_many_back(Item(11), Item(22), Item(33), Item(44), Item(55),
...
TEST(List, T0InsertManyFront) {
  ...
  s21::List<Item> s21_list_expected{
      Item(666), Item(777), Item(11), Item(22),
...
TEST(List, T1InsertManyEmptyFront) {
  ...
  s21_list.Insert_many_front(Item(11), Item(22), Item(33), Item(44), Item(55),
                             Item(66), Item(666), Item(777));
